          ...
          <div className="panel-surface mx-auto max-w-5xl rounded-2xl px-4 py-6 text-center shadow-[0_16px_38px_rgba(59,130,246,0.13)] sm:px-6 md:rounded-3xl md:px-8 md:py-10">
            ...
            <div className="mb-6 flex flex-col justify-center gap-3 sm:mb-8 sm:flex-row sm:gap-4">
              <Tooltip content="The most in depth analysis of your conversational personality.">
                <Link
                  href="/analyze"
                  className="group inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-sky-500 to-fuchsia-500 px-6 py-3.5 text-base font-semibold text-white transition-all duration-300 hover:scale-[1.02] hover:from-sky-600 hover:to-fuchsia-600 md:px-8 md:py-4 md:text-lg"
                >
              ...
              <Tooltip content="Shape the agent in a way you prefer.">
                <Link
                  href="/questionnaire"
                  className="group inline-flex items-center justify-center gap-2 rounded-xl border border-gray-700 bg-gray-800 px-6 py-3.5 text-base font-semibold text-white transition-all duration-300 hover:scale-[1.02] hover:bg-gray-700 md:px-8 md:py-4 md:text-lg"
                >
              ...
              <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:gap-4">
                <Tooltip content="Use your calendar, docs and email style to shape the agent.">
                  <button
                    ...
                    className="flex items-center justify-center gap-3 rounded-xl bg-white px-5 py-3 text-sm font-semibold text-gray-900 transition-all duration-300 hover:scale-[1.02] hover:bg-gray-100 md:px-6 md:text-base"
                  >
                ...
                <Tooltip content="Use your code review style, comments and coding interests to shape the agent.">
                  <button
                    ...
                    className="flex items-center justify-center gap-3 rounded-xl border border-gray-700 bg-gray-800 px-5 py-3 text-sm font-semibold text-white transition-all duration-300 hover:scale-[1.02] hover:bg-gray-700 md:px-6 md:text-base"
                  >
